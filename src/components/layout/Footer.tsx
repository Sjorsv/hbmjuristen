    ...
    <footer className="bg-section-grey-darker border-t border-border">
      ...
      <div className="container-editorial section-padding-sm">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-5 mt-8 pt-8 border-t border-border/50">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div className="flex items-center gap-6">
                <p className="text-sm text-muted-foreground">Lid van</p>
                <div className="flex items-center gap-5">
                  <img src={logoNmv} alt="NMv" className="h-7 w-auto object-contain opacity-70 hover:opacity-100 transition-opacity" />
                  <img src={logoNjv} alt="Nederlandse Juristen Vereniging" className="h-7 w-auto object-contain opacity-70 hover:opacity-100 transition-opacity" />
                  <img src={logoBb} alt="SBB" className="h-7 w-auto object-contain opacity-70 hover:opacity-100 transition-opacity" />
                </div>
              </div>
